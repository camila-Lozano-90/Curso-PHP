                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <a href="./frmEditar.php echo $datos->Id; ?>" type="button" class="btn btn-info" class="bi bi-pencil-square"><i class="bi bi-pencil-square"> </i></a> </td>
                                <td> <a type="button" class="btn btn-danger" href="./app/eliminarContactos.php echo $datos->Id; ?>"><i class="bi bi-trash"></i></a> </td>
